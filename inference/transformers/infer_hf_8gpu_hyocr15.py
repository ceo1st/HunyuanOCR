...
(`inference/infer_vllm_client.py` / `psp/infer_vllm_8gpu_hyocr15.py`):
...
Model loading follows `inference/infer_base.py`:
...
# ============================================================================
# Tail-repetition helpers (mirror inference/infer_vllm_client.py)
# ============================================================================
...
def unwrap_field(data: dict, key: str, default=None):
    ...
    Matches `psp/infer_vllm_8gpu_hyocr15.py::unwrap_field`.
    """
    raw = data.get(key)
    if raw is None:
        return default
...
# ============================================================================
# Tokenizer / processor loading  (mirrors inference/infer_base.py)
# ============================================================================
...
def build_stopping_criteria(
    ...
    Strictly mirrors `inference/infer_vllm_client.py::infer_stream`:
...
def parse_args():
    ...
    # Sampling — aligned with inference/infer_vllm_client.py
