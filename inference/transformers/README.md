...
Produces `./results/hf_out_1.jsonl` … `_8.jsonl`, merged into
`./results/hf_out.merged.jsonl`.
...
└── hunyuan_utils.py           # doc_parse markdown normalization (process_one), shared with the vLLM client
```
